...
namespace Exercise_07_MaxSequenceOfIncreasingElements
{
    public class maxSequenceOfIncreasingElements
    {
        ...
        static void SortArray(int[] mainArray)
        {
            ...
            {
                if (mainArray[index + 1] - mainArray[index] >= 1)
                {
        ...
        static void Print(List<int> finalString)
        {
            ...
            Console.Write(int.Parse(finalString[finalString.Count - 1].ToString()) + 1);
        }
    }
}
